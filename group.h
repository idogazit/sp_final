...
*
* @param : org_group - the original group, new_group - the destination group
*/
...
*
* @param : triv_group - the target group, graph - the source graph
*/
...
*
* @param: O - the set of groups, num_groups - the amount of groups, out_file - output file name
...
*
* @param : org_vec - the original vector, new_vec - the destination vec, dim - the sizee of the vectors
*/
